...
var regionInput = document.getElementById('new-post-region');
 ...
 */
// [START write_fan_out]
function writeNewPost(uid, username, picture, title, body, region) {
  // A post entry.
  var postData = {
    author: username,
    uid: uid,
...
function startDatabaseQueries() {
  ...
  var topUserPostsRef = firebase.database().ref('broadcasts/' + myUserId).orderByChild('starCount');
 ...
 */
function newPostForCurrentUser(title, text, region) {
...
window.addEventListener('load', function() {
  ...
  messageForm.onsubmit = function(e) {
    ...
    if (text && title) {
      newPostForCurrentUser(title, text, region).then(function() {
